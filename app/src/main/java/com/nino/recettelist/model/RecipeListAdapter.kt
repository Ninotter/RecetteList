...
import com.nino.recettelist.databinding.RecipeListItemBinding
...
class RecipeListAdapter(private val recipeList: List<Recipe>, navDetail: (input: Recipe) -> Unit) : RecyclerView.Adapter<RecipeListAdapter.ViewHolder>()  {
    ...
    private lateinit var binding: RecipeListItemBinding
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        binding = RecipeListItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class ViewHolder(private val binding: RecipeListItemBinding) : RecyclerView.ViewHolder(binding.root) {
